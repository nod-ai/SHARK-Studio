...
class DistilBertModuleTester:
    ...
    def create_and_check_module(self, dynamic, device):
        ...
        if self.save_temps == True:
            if dynamic == True:
                repro_dir = f"distilbert-base-uncased_dynamic_{device}"
            else:
                repro_dir = f"distilbert-base-uncased_static_{device}"
...
class DistilBertModuleTest(unittest.TestCase):
    ...
    @pytest.mark.xfail(reason="TODO: Distilbert dynamic issue")
