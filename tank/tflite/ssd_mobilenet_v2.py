...
# TODO Fatal Python error: Fatal Python error: Segmentation faultSegmentation fault
...
# Python error: Fatal Python error: Segmentation faultSegmentation fault

# Shark Importer forward Model
# [1]    1531874 segmentation fault (core dumped)  python ssd_mobilenet_v2.py
