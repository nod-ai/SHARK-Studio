...
#   File "ssd_mobilenet_v2_fpnlite_test.py", line 33, in test_compile_tflite
...
# Diagnostics:
# SHARK/tank/tflite/tmp/ssd_mobilenet_v2_fpnlite_test.py/model.tflite:0:0: error: 'tfl.resize_nearest_neighbor' op ConvertResizeOp: resize dynamic input not supported.
# SHARK/tank/tflite/tmp/ssd_mobilenet_v2_fpnlite_test.py/model.tflite:0:0: note: see current operation: %345 = "tfl.resize_nearest_neighbor"(%294, %344)

# Traceback (most recent call last):
#   File "ssd_mobilenet_v2_fpnlite.py", line 30, in <module>
#     my_shark_importer.compile()
...
#   File "/home/chi/src/ubuntu20/shark/SHARK/shark.venv/lib/python3.8/site-packages/iree/compiler/tools/binaries.py", line 200, in invoke_immediate
#     raise CompilerToolError(process)
# iree.compiler.tools.binaries.CompilerToolError: Error invoking IREE compiler tool iree-import-tflite
# Diagnostics:
# SHARK/shark/tmp/ssd_mobilenet_v2_fpnlite.py/model.tflite:0:0: error: 'tfl.resize_nearest_neighbor' op ConvertResizeOp: resize dynamic input not supported.
# SHARK/shark/tmp/ssd_mobilenet_v2_fpnlite.py/model.tflite:0:0: note: see current operation: %345 = "tfl.resize_nearest_neighbor"(%294, %344) {align_corners = false, half_pixel_centers = false} :
